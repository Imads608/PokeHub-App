...
const drawerSlice = createSlice({
    name: 'drawer-state',
    initialState: { drawerToggle: false, chatroomsToggle: false, dmsToggle: false } as DrawerState,
    reducers: {
...
export const { drawer_closed, drawer_opened, chatrooms_closed, chatrooms_opened, dms_closed, dms_opened } = drawerSlice.actions;
