    ...
    <div className="chat-sidebar">
      ...
      <List>
        <ListItem
          button
          component={Link}
          to={{ pathname: location.pathname, search: `?view=rules` }}
        ...
        >
          ...
          <ListItemText primary={<h4 className="theme-text">Rules</h4>} />
        </ListItem>
        <ListItem
          button
          component={Link}
        ...
        >
          ...
          <ListItemText primary={<h4 className="theme-text">Lobby</h4>} />
        </ListItem>
        <ListItem
          button
          component={Link}
          to={{ pathname: location.pathname, search: `?view=members` }}
        ...
        >
          ...
          <ListItemText primary={<h4 className="theme-text">Members</h4>} />
        </ListItem>
      </List>
    </div>
  );
