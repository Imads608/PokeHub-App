...
export class RoomController { 
    ...
    getAllPublicRooms(): Promise<ChatRoom[]> {
        this.logger.log(`getAllPublicRooms: Got request to retrieve All Public Chat Rooms`);
    ...
    getPublicRoomDetails(@Param() params): Promise<ChatRoom> {
        this.logger.log(`getPublicRoomDetails: Got request to retrieve data for Public Chat Room ${params.roomId}`);
    ...
    getUsersForPublicRoom(@Param() params): Promise<UserData[]> {
        this.logger.log(`getUsersForPublicRoom: Got request to retrieve all Users for Public Chat Room ${params.roomId}`);
