import { Body, Controller, Get, Inject, Post, Req, UnauthorizedException, UseGuards, UseInterceptors } from '@nestjs/common';
import { CreateUserRequest, UserDataWithToken, UserPublicProfile, UserPublicProfileWithToken } from '@pokehub/user';
