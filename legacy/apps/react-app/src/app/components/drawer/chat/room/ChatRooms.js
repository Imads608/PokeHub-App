...
import { List, ListItemText, ListItem, MenuItem, Menu } from '@mui/material';
      ...
      >
          ...
          <List className={classes.headerBlock}>
            <ChatIcon
              ...
              className={`drawer-icon ${
                chatroomsMenuToggle ? 'drawer-header-expanded' : 'drawer-header'
              }`}
            />
            <ListItemText
              primary={
        ...
        <AccordionDetails className="drawer-accordion-details">
          <List className="drawer-expanded-list">
            {activeChatRooms &&
              activeChatRooms.map((opened) => (
                <ListItem
                  button
                  component={Link}
                  to={{
                    pathname: opened.state.url.pathname,
                    search: opened.state.url.search,
                  }}
                  selected={
            ...
            <ListItem
              button
              disabled={
                activeChatRooms && activeChatRooms.length === chatrooms.length
                  ? true
                  : false
              }
              onClick={openMenu}
            ...
            >
              ...
              >
                {chatrooms &&
                  chatrooms.map(
                    (room, id) =>
                      !activeChatRooms.find(
                        (opened) => opened.id === room.id
                      ) && (
                        <MenuItem
                          component={Link}
