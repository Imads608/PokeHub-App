  ...
  return (
    <Paper className={classes.trainerCard} elevation={4}>
      <div className="trainer-card-header">
        <img
          style={{ height: '30px', width: '20px', marginRight: '5px' }}
          src={TrainerCardHeaderLeft}
        />
        <span className="theme-text">TRAINER CARD</span>
        <img
          style={{ height: '30px', width: '20px', marginLeft: '5px' }}
          src={TrainerCardHeaderRight}
        />
      </div>
      <div className="trainer-card-user">
        <Avatar className="trainer-card-avatar" src="/broken-image.jpg" />
        <h4 style={{ marginBottom: 0 }} className="theme-text">
          ID
        </h4>
        <Divider variant="fullWidth" />
        <h3
          className="theme-text"
          style={{ overflowWrap: 'break-word', marginBottom: 0 }}
        >
          {user.uid}
        </h3>
        <h4 style={{ marginBottom: 0 }} className="theme-text">
        ...
        <Divider variant="fullWidth" />
        <h3 style={{ marginBottom: 0 }} className="theme-text">
          {user.username}
        </h3>
      </div>
