...
class Register extends React.Component {
  ...
  validateSignup() {
    let error = {
      errorEmail: this.state.email.error,
      errorPass: this.state.password.error,
      errorUN: this.state.username.error,
    };
    if (error.errorPass === null && this.state.password.value === '')
      error.errorPass = 'Password is required';
    if (error.errorEmail === null && this.state.email.value === '')
      error.errorEmail = 'Email is required';
    if (error.errorUN === null && this.state.username.value === '')
      error.errorUN = 'Username is required';
    return error;
  }
...
export default connect(mapStateToProps, { googleSignIn, createUser })(
