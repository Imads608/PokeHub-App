    ...
    >
        ...
        >
          <div
            ...
            style={{
              ...
              transform: `scaleY(${scaleMale})`,
              width: `${getMaleGenderRate()}%`,
              height: '20px',
          ...
          <div
            ...
            style={{
              textAlign: 'center',
              transition: 'all .3s ease-in-out',
              transform: `scaleY(${scaleFemale})`,
              width: `${getFemaleGenderRate()}%`,
              height: '20px',
      ...
      <SpeciesInfoRow>
        <SpeciesItemDetail title="Height">
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ margin: '0 5px 0 0' }}>
              {((dexEntryData.height * 0.1) / 0.3048).toFixed(0)}'
              {((((dexEntryData.height * 0.1) / 0.3048) * 12) % 12).toFixed(0)}
            </div>
            <div style={{ margin: '0 0 0 5px' }}>
              {(dexEntryData.height * 0.1).toFixed(2)} m
            </div>
          </div>
        </SpeciesItemDetail>
        <SpeciesItemDetail title="Weight">
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ margin: '0 5px 0 0' }}>
              {(dexEntryData.weight * 0.1 * 2.20462262185).toFixed(1)} lbs
            </div>
            <div style={{ margin: '0 0 0 5px' }}>
              {dexEntryData.weight * 0.1} kg
            </div>
          </div>
        </SpeciesItemDetail>
      </SpeciesInfoRow>
      ...
      <SpeciesInfoRow>
        <SpeciesItemDetail title="Shape">
          <img
            ...
            src="https://cdn2.bulbagarden.net/upload/d/d3/Body03.png"
            alt="Body Shape"
          />
        </SpeciesItemDetail>
      </SpeciesInfoRow>
