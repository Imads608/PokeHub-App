import { useSendAccountActivation } from '../../../hooks/auth/send-account-activation.hook';
...
const PasswordResetNotification: () => JSX.Element = () => {
  ...
  return (
    ...
    >
      <Collapse in={open}>
          ...
          action={
            <>
              <Button
                ...
                onClick={() => mutation.mutate(user as IJwtTokenBody)}
              >
                Resend
              </Button>
        ...
        >
          We have sent an Email to the Provided Email Id to Activate Your
          Account.
        </Alert>
      </Collapse>
    </Box>
