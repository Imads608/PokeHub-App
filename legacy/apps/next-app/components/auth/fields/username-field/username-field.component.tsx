...
import { withUsernameAvailableField } from './username-field-availability.hoc';
import { useFieldStyles } from '../field.styles';
...
export default withUsernameAvailableField(UsernameField);
