...
import { useTrainerCardStyles } from './trainer-card.styles';
            ...
            <Paper className={classes.root} elevation={4}>
                <div className={classes.header}>
                    <span style={{ marginRight: '5px', display: 'flex', alignItems: 'center' }}>
                        <Image height={30} width={20} src='/images/TrainerCardHeaderLeft.png' alt='Trainer Card Header Left' />
                    </span>
                    <span>TRAINER CARD</span>
                    <span style={{ marginLeft: '5px', display: 'flex', alignItems: 'center' }}>
                        <Image height={30} width={20} src='/images/TrainerCardHeaderRight.png' alt='Trainer Card Header Right' />
                    </span>
                </div>
