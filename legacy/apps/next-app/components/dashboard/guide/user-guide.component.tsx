...
import AvatarSetup from './avatar-setup.component';
import UserNameSetup from './username-setup.component';
import CloseIcon from '@mui/icons-material/Close';
import { useUserProfileMutation } from '../../../hooks/user/user-profile.hook';
