...
export interface IRoomService {
   ...
   */
  getAllPublicRooms(): Promise<ChatRoom[] | null>;
   ...
   */
  getPublicRoomById(roomId: string): Promise<ChatRoom | null>;
   ...
   */
  getUserJoinedRooms(userId: string): Promise<ChatRoom[] | null>;
   ...
   */
  getChatRoomParticipants(roomId: string): Promise<Participant[] | null>;
}
